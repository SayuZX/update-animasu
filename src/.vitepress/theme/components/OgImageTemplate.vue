...
<template>
  <div
    ...
    style="background:linear-gradient(0deg, rgba(255, 255, 255, 0.92), rgba(231,230,255,0.86)), url(https://raw.githubusercontent.com/SayuZX/update-animasu/refs/heads/main/images/file.png)"
  >
