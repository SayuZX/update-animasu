...
const changelog = computed(() => {
  const flavoredString = (release[type.value].body ?? '')
    ...
    .replace('https://github.com/SayuZX/update-animasu/releases', '/changelogs/')
...
<template>
  ...
  <div class="fullChangelog">
    <p>
      ...
      <a href="https://github.com/SayuZX/update-animasu/releases/latest" target="_blank" rel="noopener">
        here
      </a>
    </p>
  </div>
