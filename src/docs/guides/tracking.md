...
- Tracking is one-way: **Kuma Anime -> Tracker**.
...
If you cannot find a series by name, you can look it up on MyAnimeList and then search for it in **Kuma Anime** using the following format: `id:<id from series URL>`.
