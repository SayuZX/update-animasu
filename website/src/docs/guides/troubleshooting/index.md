...
# Troubleshooting (Soon version 4.0)
...
Using non-standard **WebView** (like **Firefox**) might cause **Kuma Anime** to malfunction or crash.
...
Some sources intentionally have higher **Cloudflare** protection to deter apps like **Kuma Anime**.
