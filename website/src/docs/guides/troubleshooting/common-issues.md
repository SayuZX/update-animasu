...
* Else, delete **Kuma Anime** downloads folder on SD card.

### Storage issues with Android 11+
See [this](/docs/faq/storage) section of the FAQ to learn how Scoped Storage affects **Kuma Anime** in **Android 11+** and how to fix it.
...
* Enable **DNS over HTTPS** to your settings.
...
* In <nav to="App Info">, try **Clear cache**.
* Change network (Wi-Fi, mobile data, VPN).
* Reboot device.

### `Attempt to invoke virtual method 'app.kumaanime...'`

Storage-related error causes:

* Storage full, check device/SD Card.
* Grant **Kuma Anime** SD card access in Android settings.
