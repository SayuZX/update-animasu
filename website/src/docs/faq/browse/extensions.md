...
Kuma Anime is bring-your-own-content and does not offer anything.

::: info Disclaimer
**Kuma Anime** isn't responsible for slow, down, missing chapters/episodes, or subpar image/video quality of sources as it doesn't host content.
:::
...
Uninstall extensions like regular apps: through device settings or in **Kuma Anime**.

::: tip Uninstalling an extension
In **Kuma Anime**, uninstall an extension via <nav to="extensions">, then tap **Uninstall** on the chosen extension.
:::
