...
function handleAnalytics(type: 'preview' | 'stable') {
  window.gtag?.('event', 'Download', {
    event_category: 'App',
    event_label: type === 'stable' ? 'Stable' : 'Pre-release',
    version: type === 'stable'
...
<template>
  <div>
    <div v-if="!isAndroid" class="custom-block danger">
      ...
      <p>
        <strong>Kuma Anime</strong> is an <strong>Android app</strong> only.
    ...
    <div v-if="!isAndroid" class="custom-block warning">
      ...
      <p>
        ...
        <strong>Kuma Anime</strong> is not affiliated with this project.
      </p>
      <blockquote>
